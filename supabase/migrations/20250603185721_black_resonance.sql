/*
  # Tavus Integration Schema
  
  1. New Tables
    - None (using existing tables with metadata)
  
  2. Changes
    - Add tavus_replica_id to user_settings
    - Use persona_content for storing videos
  
  3. Security
    - Update RLS policies to ensure proper access controls
*/
...
-- Document the expected structure of the metadata field for Tavus videos
