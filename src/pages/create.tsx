                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                  ...
                  >
                    <CardHeader className="pb-3">
                      ...
                      <CardDescription>
                        Build your persona completely custom
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
            ...
            {step === 2 && (
              <div>
                ...
                <p className="text-sm text-gray-600 mb-6">
                  Choose the traits that define your persona's character and behavior.
                  Selected traits will influence how your persona interacts.
                </p>
            ...
            {step === 3 && (
              <div>
                ...
                <div className="mt-8 flex justify-between">
                  ...
                  <Button
                    onClick={nextStep}
                    disabled={!personaName || !personaDescription}
                  >
                    Continue <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                </div>
                  ...
                  <div className="bg-gray-50 px-6 py-4">
                    <div className="flex items-start">
                      ...
                      <p className="text-sm text-gray-600">
                        Your persona will be created with the traits and settings you've selected.
                        You can modify these settings later from your dashboard.
                      </p>
                    </div>
                  </div>
                </div>
