...
const PricingPage: React.FC<PricingPageProps> = ({ className = '' }) => {
  ...
  const getFeatureIcon = (feature: string) => {
    if (feature.includes('Persona')) return <Users className="h-4 w-4" />;
    if (feature.includes('Text-to-Speech')) return <MessageCircle className="h-4 w-4" />;
    if (feature.includes('Voice Cloning')) return <Mic className="h-4 w-4" />;
    if (feature.includes('Live Conversation')) return <Clock className="h-4 w-4" />;
    if (feature.includes('Monetization')) return <DollarSign className="h-4 w-4" />;
    if (feature.includes('Event')) return <Calendar className="h-4 w-4" />;
